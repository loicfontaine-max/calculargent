...
export const metadata: Metadata = {
  title: "Guides pratiques sur l’épargne, le budget et le crédit | CalculArgent",
...
export default function GuidesPage() {
  ...
  return <main>
    ...
    <nav className="nav"><a className="brand" href="/"><span>Calcul</span><b>Argent</b></a><div className="navLinks"><a href="/#outils">Calculateurs</a><a href="/guides">Guides</a><a href="/methode">Méthode</a></div><a className="back" href="/">← Accueil</a></nav>
