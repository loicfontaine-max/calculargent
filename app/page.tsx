...
export default function Home() {
  ...
  return <main>
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@graph": [{ "@type": "WebSite", "@id": "https://calculargent.fr/#website", name: "CalculArgent", alternateName: "Calcul Argent", url: "https://calculargent.fr", description: "Des calculateurs simples et gratuits pour l’épargne, les dettes et le patrimoine.", inLanguage: "fr-FR", isAccessibleForFree: true, publisher: { "@id": "https://calculargent.fr/#organization" }, author: { "@type": "Person", name: "Loïc Fontaine", url: "https://calculargent.fr/auteur" } }, { "@type": "Organization", "@id": "https://calculargent.fr/#organization", name: "CalculArgent", url: "https://calculargent.fr", founder: { "@type": "Person", name: "Loïc Fontaine", url: "https://calculargent.fr/auteur" }, publishingPrinciples: "https://calculargent.fr/methode" }] }) }} />
      <nav className="nav"><a className="brand" href="#top"><span>Calcul</span><b>Argent</b></a><div className="navLinks"><a href="#outils">Calculateurs</a><a href="/guides">Guides</a><a href="/lexique">Lexique</a><a href="/epargne">Épargne</a><a href="#methode">Méthode</a></div><a className="navCta" href="#outils">Commencer</a></nav>
